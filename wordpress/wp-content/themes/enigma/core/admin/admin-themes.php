...
function enigma_admin_info(){
	...
	wp_enqueue_style( 'font-awesome-581', get_template_directory_uri(). '/css/fontawesome6.2.0/css/all.css');
...
<div class="snow"></div>
	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/christmas-banner2.png" class="img-responsive" style="width:100%;height:auto;" alt=""/>
</div>
				...
				<div id="start" class="tab-pane fade in active">
                        <div class="space  theme active">
							...
							<div class="row p_plugin blog_gallery visit_pro">
								...
								<a href="https://www.infigosoftware.in/themes/enigma-premium/">Visit Themes</a>
                            </div>	
                        </div>
                    </div>
							...
							<div class="row p_plugin blog_gallery">
                                <div class="col-xs-12 col-sm-4 col-md-4 p_plugin_pic">
                                    <div class="img-thumbnail pro_theme">
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/492X-CORPO.jpg" class="img-responsive" alt="img"/>
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4 p_plugin_pic">
                                    <div class="img-thumbnail pro_theme">
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/Responsive-Beauty.png" class="img-responsive" alt="img"/>
										<div class="btn-vertical">
										<h4 class="pro_thm">
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4 p_plugin_pic">
                                    <div class="img-thumbnail pro_theme">
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/healthcare1.png" class="img-responsive" alt="img"/>
										<div class="btn-vertical">
										<h4 class="pro_thm">
